...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mute-glade-2f4f)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mute-glade-2f4f
```

A live public deployment of this template is available at [https://mute-glade-2f4f.templates.workers.dev](https://mute-glade-2f4f.templates.workers.dev)
